...
function CarouselContent({ currentIndex, handleNext, handlePrev, data }) {
    ...
    return(
        <div className="grid grid-cols-5 grid-rows-1 max-md:grid-cols-1 max-md:grid-rows-2">
            ...
            <div
                className={`col-span-3 w-full h-full transition-opacity duration-150 ease-in-out`}>
                <img src={imageMap[imageSrc]} alt="hero image" className="w-full h-full" />
            </div>
            <div
                className={`p-20 pt-36 max-xl:p-8 max-xl:py-32 max-lg:py-16 max-lg:pt-20 max-sm:pt-14 col-span-2 transition-opacity ease-in-out`}
            >
